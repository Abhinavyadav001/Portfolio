  ...
  return (
    <footer className="bg-[#0f172a] text-gray-300 px-6 py-12 md:px-16 lg:px-24">
      <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-12 mb-12">
        ...
        <div>
          ...
          <p className="mt-4 text-gray-400 leading-relaxed">
            MERN Stack Developer | Passionate about AI, and building
            production-grade full-stack applications.
          </p>
          <div className="flex gap-4 mt-6 text-xl">
            <a
              href="https://github.com/Abhinavyadav001"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/abhinav-yadav-033a3525b/"
              target="_blank"
              rel="noopener noreferrer"
              title="LinkedIn"
              className="hover:text-purple-400 transition-transform transform hover:scale-110"
            ...
            <a
              href="mailto:abhinavyadav202004@gmail.com"
              title="Email"
              className="hover:text-purple-400 transition-transform transform hover:scale-110"
            >
              <FaEnvelope />
        ...
        <div className="flex flex-col justify-between items-start lg:items-end">
          <div className="text-left lg:text-right">
            <p className="text-lg font-medium">© {year} | Abhinav Yadav</p>
            <p className="text-sm text-gray-400 mt-1">
              CSE @ IIIT Raichur | Developer & Tech Enthusiast
            </p>
          </div>
          <button
            onClick={scrollToTop}
      ...
      <div className="text-center text-sm text-gray-500 border-t border-gray-700 pt-6">
        ...
        <span className="text-white font-medium">Abhinav Yadav</span>
      </div>
    </footer>
  );
}
