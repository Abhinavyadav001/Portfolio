...
const coreSkills = [
  { name: 'React.js', icon: <FaReact />, percent: 90, color: '#10B981' },
  { name: 'Next.js', icon: <SiNextdotjs />, percent: 80, color: '#10B981' },
  { name: 'Python', icon: <FaPython />, percent: 60, color: '#10B981' },
  { name: 'C Programming', icon: <SiC />, percent: 85, color: '#F97316' },
  { name: 'Machine Learning', icon: <FaRobot />, percent: 55, color: '#FBBF24' },
  { name: 'DSA', icon: <FaCode />, percent: 80, color: '#10B981' },
];
